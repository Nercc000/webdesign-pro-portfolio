...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "dark:bg-gradient-to-br dark:from-black dark:via-blue-950/20 dark:to-black transform-gpu dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] dark:[border:1px_solid_rgba(59,130,246,.1)]",
      className
    )}
    {...props}
  >
