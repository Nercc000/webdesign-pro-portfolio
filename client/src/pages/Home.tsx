                ...
                "allgemein": [
                  {
                    ...
                    answer: "Die Kosten variieren je nach Umfang und Anforderungen. Eine einfache Business-Website startet bei ca. €1.500, während umfangreichere Projekte mit E-Commerce oder individuellen Funktionen ab €3.000 beginnen. Im kostenlosen Erstgespräch erstelle ich Ihnen ein transparentes Angebot ohne versteckte Kosten."
                  },
                  {
                    question: "Wie lange dauert die Erstellung einer Website?",
                    answer: "Eine Standard-Website ist in der Regel innerhalb von 2-4 Wochen fertig. Der genaue Zeitrahmen hängt von der Komplexität des Projekts und der Geschwindigkeit Ihres Feedbacks ab. Ich halte Sie während des gesamten Prozesses auf dem Laufenden und arbeite nach einem klaren Zeitplan."
                  },
                  {
                    question: "Welche Technologien verwenden Sie?",
                    answer: "Ich arbeite mit modernen, zukunftssicheren Technologien wie React, TypeScript, Next.js und Tailwind CSS für maßgeschneiderte Lösungen. Für Content-Management-Systeme setze ich auf WordPress. Alle Websites sind responsive, schnell und SEO-optimiert – garantiert."
                  },
                  {
                    question: "Bieten Sie auch Wartung und Support an?",
                    answer: "Ja, ich biete verschiedene Wartungspakete an. Diese umfassen regelmäßige Updates, Sicherheits-Backups, technischen Support und kleinere Anpassungen. Sie können zwischen monatlichen oder jährlichen Paketen wählen – ganz nach Ihrem Bedarf."
                  },
                  {
                    question: "Kann ich meine Website selbst aktualisieren?",
                    answer: "Absolut! Bei WordPress-Projekten erhalten Sie ein benutzerfreundliches Content-Management-System, mit dem Sie Texte, Bilder und Inhalte selbst ändern können. Ich schule Sie gerne in der Bedienung und stelle Ihnen eine ausführliche Dokumentation zur Verfügung."
                  },
                  {
                    question: "Wie läuft die Zusammenarbeit ab?",
                    answer: "Nach dem kostenlosen Erstgespräch erstelle ich Ihnen ein Angebot. Bei Zusage beginnen wir mit der Konzeption und dem Design. Sie erhalten regelmäßige Updates und können jederzeit Feedback geben. Nach Ihrer finalen Freigabe geht die Website live. Keine Vorkasse erforderlich – Sie zahlen erst bei Zufriedenheit."
                  },
                  {
                    question: "Was passiert, wenn mir das Ergebnis nicht gefällt?",
                    answer: "Ihre Zufriedenheit ist meine Priorität. Während des Projekts haben Sie mehrere Feedback-Runden, um sicherzustellen, dass alles Ihren Vorstellungen entspricht. Sollten Sie am Ende dennoch nicht zufrieden sein, biete ich eine Geld-zurück-Garantie. Ihr Risiko ist minimal."
                  }
                ]
              }}
              className="-mx-4 py-0"
